...
CSV_PATH = "rwt_quarterly_eps_complete.csv"
CHART_PATH = "rwt_eps_chart.png"
...
colors = ["#2ca02c" if v >= 0 else "#d62728" for v in eps_values]
...
bars = ax.bar(quarters, eps_values, color=colors)
...
ax.set_title("Redwood Trust (RWT) — Quarterly Diluted EPS")
ax.set_xlabel("Quarter")
ax.set_ylabel("EPS (USD/share)")
